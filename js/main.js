...
const SEARCH_INDEX = [
  ...
  // Blog posts
  { type: 'post', name: 'Building a Full-Stack App with Next.js & MongoDB', desc: 'Web Dev · Apr 12, 2024', rootHref: 'pages/posts/next-mongodb.html', tag: '8 min' },
  { type: 'post', name: 'How I Use Claude to 10x My Dev Workflow', desc: 'AI · Mar 28, 2024', rootHref: 'pages/posts/claude-workflow.html', tag: '6 min' },
  { type: 'post', name: 'TypeScript Patterns I Wish I Knew Earlier', desc: 'Web Dev · Mar 10, 2024', rootHref: 'pages/posts/typescript-patterns.html', tag: '10 min' },
  { type: 'post', name: 'Landing My First Dev Job Without a CS Degree', desc: 'Career · Feb 20, 2024', rootHref: 'pages/posts/first-dev-job.html', tag: '12 min' },
  { type: 'post', name: 'My 2024 Developer Setup', desc: 'Tools · Feb 5, 2024', rootHref: 'pages/posts/dev-setup.html', tag: '7 min' },
  { type: 'post', name: 'The Future of Frontend in an AI World', desc: 'AI · Jan 18, 2024', rootHref: 'pages/posts/ai-frontend.html', tag: '9 min' },
  { type: 'post', name: 'CSS Grid vs Flexbox: When to Use Which', desc: 'Web Dev · May 2, 2024', rootHref: 'pages/posts/css-grid-vs-flexbox.html', tag: '7 min' },
  // Skills
  { type: 'skill', name: 'React', desc: 'Frontend library', rootHref: 'index.html#skills', tag: 'Skill' },
  { type: 'skill', name: 'Next.js', desc: 'React framework', rootHref: 'index.html#skills', tag: 'Skill' },
  { type: 'skill', name: 'TypeScript', desc: 'Typed JavaScript', rootHref: 'index.html#skills', tag: 'Skill' },
  { type: 'skill', name: 'Python', desc: 'Backend & scripting', rootHref: 'index.html#skills', tag: 'Skill' },
  { type: 'skill', name: 'Node.js', desc: 'Server-side JS', rootHref: 'index.html#skills', tag: 'Skill' },
  { type: 'skill', name: 'MongoDB', desc: 'NoSQL database', rootHref: 'index.html#skills', tag: 'Skill' },
  { type: 'skill', name: 'TailwindCSS', desc: 'Utility-first CSS', rootHref: 'index.html#skills', tag: 'Skill' },
  // Social
